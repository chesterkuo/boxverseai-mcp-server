...
export const listTasksTool = {
    ...
    description: "List tasks for an AI agent. Can filter by featureId (4 for ListenME), " +
    ...
    inputSchema: {
        ...
        status: z.array(z.number()).optional().describe("Filter by status: 0=upcoming, 1=active, 2=ended, 3=cancelled, 4=deleted, " +
